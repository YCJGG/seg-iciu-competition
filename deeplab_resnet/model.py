...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('res5b_relu', 
             ...
             .atrous_conv(3, 3, num_classes, 14, padding='SAME', relu=False, name='fc1_voc12_c0'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, num_classes, 20, padding='SAME', relu=False, name='fc1_voc12_c1'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, num_classes, 26, padding='SAME', relu=False, name='fc1_voc12_c2'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, num_classes, 32, padding='SAME', relu=False, name='fc1_voc12_c3'))
